...
LOOPLIST_Ex_ rb_t Uart1rb;  //创建一个环形队列管理变量
LOOPLIST_Ex_ rb_t Uart1rbManage;  //创建一个环形队列管理变量

LOOPLIST_Ex_ void rbCreate(rb_t *rb,void *Buff,uint32_t BuffLen);//创建或者说初始化环形缓冲区
